...
CREATE TABLE IF NOT EXISTS "food_consumptions" (
  ...
  PRIMARY KEY ("id"),
  FOREIGN KEY("food_list") REFERENCES "foods"("id") ON DELETE CASCADE,
  FOREIGN KEY("dishes_list") REFERENCES "dishes"("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "food_consumptions_food_id_bridge" (
  ...
  CONSTRAINT "fk_food_consumptions_id"
  FOREIGN KEY ("food_consumptions_id") REFERENCES "food_consumptions"("id"),
...
CREATE TABLE IF NOT EXISTS "food_consumptions_dish_id_bridge" (
  ...
  CONSTRAINT "fk_food_consumptions"
  FOREIGN KEY ("food_consumptions") REFERENCES "food_consumptions"("id"),
...
CREATE TABLE IF NOT EXISTS "history_entry_consumed_food_bridge" (
  ...
  CONSTRAINT "fk_consumed_food_id"
  FOREIGN KEY ("consumed_food_id") REFERENCES "food_consumptions"("id"),
